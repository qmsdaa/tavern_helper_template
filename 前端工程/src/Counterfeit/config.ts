...
export const PORTRAIT_BASE = 'https://cdn.jsdelivr.net/gh/qmsdaa/tavern_helper_template_cdn@c947510/assets/Counterfeit/状态栏/portraits';
export const STATUS_AVATAR_BASE = 'https://cdn.jsdelivr.net/gh/qmsdaa/tavern_helper_template_cdn@c947510/assets/Counterfeit/状态栏/avatars';
...
export const ASSET_VERSION = '20260818b';
